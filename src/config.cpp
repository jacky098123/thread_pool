...
int Config::GetConfInt(const string &section, const string &name, int* value, int def) {
    string value_string;
    int ret;

    ret = GetConfStr(section, name, value_string );
...
int Config::GetConfStr(const string &section, const string &name, string &value, const string &def) {
...
int Config::WriteConfStr(const string &section, const string &name, const string &value) {
...
int Config::WriteConfInt(const string &section, const string &name, int value) {
    char   value_buf[12];

    snprintf(value_buf, sizeof(value_buf), "%d", value);
    return WriteConfStr(section, name, value_buf);
}
